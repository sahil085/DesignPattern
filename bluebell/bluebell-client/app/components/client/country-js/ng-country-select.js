(function() {
  ...
  angular.module('countrySelect', []).directive('countrySelect', function() {
    ...
    return {
      ...
      template: '<select ng-options="country.name as country.name for country in countries"> <option value="" ng-if="isSelectionOptional">Select a Country</option> </select>',
      controller: [
